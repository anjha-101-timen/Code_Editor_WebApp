document.addEventListener('DOMContentLoaded', function () {
    const inputColorBtn = document.getElementById('inputColorBtn');
    const inputTextArea = document.getElementById('input-area');

    // Retrieve saved color from local storage or default to black
    let savedColor = localStorage.getItem('inputTextareaColor') || '#000000';
    inputTextArea.style.color = savedColor;

    inputColorBtn.addEventListener('click', function () {
        ...
        okButton.addEventListener('click', function () {
            ...
            inputTextArea.style.color = savedColor;
            localStorage.setItem('inputTextareaColor', savedColor);
