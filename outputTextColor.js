document.addEventListener('DOMContentLoaded', function () {
    const outputColorBtn = document.getElementById('outputColorBtn');
    const outputTextArea = document.getElementById('output-area');

    // Retrieve saved color from local storage or default to black
    let savedColor = localStorage.getItem('outputTextareaColor') || '#000000';
    outputTextArea.style.color = savedColor;

    outputColorBtn.addEventListener('click', function () {
        ...
        okButton.addEventListener('click', function () {
            ...
            outputTextArea.style.color = savedColor;
            localStorage.setItem('outputTextareaColor', savedColor);
