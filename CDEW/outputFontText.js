document.addEventListener('DOMContentLoaded', function () {
    const outputFontBtn = document.getElementById('outputFontBtn');
    ...
    let savedFont = localStorage.getItem('outputTextAreaFont') || "'Ubuntu', monospace";
    outputTextArea.style.fontFamily = savedFont;

    outputFontBtn.addEventListener('click', function () {
        // Blur only the output text box area
        ...
        fontModal.style.position = 'absolute'; // Positioned relative to the output text box
        ...
        // Position the modal at the center of the output area
        const outputRect = outputTextArea.getBoundingClientRect();
        fontModal.style.top = `${outputRect.top + window.scrollY + outputRect.height / 2}px`;
        fontModal.style.left = `${outputRect.left + window.scrollX + outputRect.width / 2}px`;
        ...
        okButton.addEventListener('click', function () {
            ...
            outputTextArea.style.fontFamily = selectedFont;
            localStorage.setItem('outputTextAreaFont', selectedFont);
