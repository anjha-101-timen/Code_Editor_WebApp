document.addEventListener('DOMContentLoaded', function() {
    const inputTextImageBtn = document.getElementById('inputTextImageBtn');
    const inputArea = document.getElementById('input-area');

    inputTextImageBtn.addEventListener('click', function() {
    ...
    function showResolutionSelect() {
        ...
        const btnRect = inputTextImageBtn.getBoundingClientRect();
        selectContainer.style.left = `${btnRect.left + inputTextImageBtn.offsetWidth + 10}px`;
    ...
    function takeResolutionScreenshot(targetWidth) {
        ...
        link.href = dataURL;
        link.download = `${targetWidth}_input_screenshot.png`;
        link.click();
    }
});