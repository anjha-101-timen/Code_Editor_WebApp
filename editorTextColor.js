document.addEventListener('DOMContentLoaded', function () {
    ...
    let savedColor = localStorage.getItem('editorColor') || '#000000';
    editorElement.style.color = savedColor;
    aceEditor.setOptions({
        textColor: savedColor
    });

    editorColorBtn.addEventListener('click', function () {
        ...
        okButton.addEventListener('click', function () {
            ...
            localStorage.setItem('editorColor', savedColor);
