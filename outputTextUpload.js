document.getElementById('outputTextUploadBtn').addEventListener('click', () => {
    ...
    fileInput.addEventListener('change', (event) => {
      ...
      reader.onload = (e) => {
        ...
        // Display the content in the output-area
        document.getElementById('output-area').value = fileContent;
      };
